...
class TestNavigation:
    ...
    def test_click_on_account_link_redirects_to_account_page(self, driver, user_data):
    ...
    def test_click_on_constructor_redirects_to_main_page(self, driver, user_data):
        register_user(driver, user_data)
        login_user(driver, user_data)
        driver.find_element(*MainPageLocators.ACCOUNT_LINK).click()
    ...
    def test_click_on_logo_redirects_to_main_page(self, driver, user_data):
        register_user(driver, user_data)
        login_user(driver, user_data)
        driver.find_element(*MainPageLocators.ACCOUNT_LINK).click()
