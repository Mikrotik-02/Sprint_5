...
def test_click_on_buns_tab_makes_buns_tab_active(driver):
    driver.get(MAIN_URL)
...
def test_click_on_sauces_tab_makes_sauces_tab_active(driver):
    driver.get(MAIN_URL)
...
def test_click_on_fillings_tab_makes_fillings_tab_active(driver):
    driver.get(MAIN_URL)
